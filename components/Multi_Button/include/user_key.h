...
typedef struct key_config
{
  ...
  uint32_t long_pressed_time2;                                            ///< 按键长按时间,单位us
} key_config_t;
...
typedef struct key_param
{
  ...
  user_key_function_callback_t long_press_callback2;                       ///< 长按的回调函数
...
typedef struct key_time_params
{
  ...
  esp_timer_handle_t long_press_time_handle2;                              ///< 用于按键长时的计时
} key_time_params_t;
